  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Appointments list for the rail. (Map pins only ever drew on the retired
        // mapbox canvas; the keyless Google canvas focuses the checked address, so
        // per-appt geocoding is dropped — the rail list is the surface.)
