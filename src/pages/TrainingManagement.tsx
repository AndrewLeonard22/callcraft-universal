...
const [moduleForm, setModuleForm] = useState({
  ...
  const loadModules = async () => {
    try {
      ...
      // Batched: was 1 + N-sections + 3×M-nested queries (N+1 fan-out). Now 4 flat
      // queries (.in() on module_ids, then .in() on section_ids ×3) reassembled
      // client-side, display_order preserved. Mirrors the Training.tsx fix.
