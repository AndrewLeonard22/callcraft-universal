...
DROP POLICY IF EXISTS "Organization members can view scripts" ON public.scripts;
DROP POLICY IF EXISTS "Organization members can create scripts" ON public.scripts;
DROP POLICY IF EXISTS "Organization members can update scripts" ON public.scripts;
DROP POLICY IF EXISTS "Owners and admins can delete scripts" ON public.scripts;
